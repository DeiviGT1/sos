            ...
            <div className="footer-text">
              <div className="info-contact">
                ...
                <div className="textwidget">
                  <p> Teléfonos</p>
                  <span className="phone"><a href="tel:6043669908"> <p>(604) 366 9908 </p></a></span>
                  <span className="cell"><a href="tel:+573108956559"><p> (+ 57) 310 895 65 59 </p></a></span>
                  <p>Dirección</p>
                  <span className="addres"><a href="https://maps.app.goo.gl/uEcbZHnbezJid33k6"><p>CLL 44 No. 79 - 157</p></a></span>
